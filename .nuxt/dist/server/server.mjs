var _a, _b;
import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, watch, isRef, isReactive, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, isShallow, resolveComponent, mergeProps, withCtx, createTextVNode, useSSRContext, Suspense, Transition, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const unhead_JBTa5mjwlu = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  ...
  },
  {
    ...
    path: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.path) ?? "/Index",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/Random-Ch6KnLPa.js").then((m) => m.default || m)
  },
  {
    name: "tag-list",
    path: "/tag-list",
...
const revive_payload_server_1mUFz4J7dI = /* @__PURE__ */ defineNuxtPlugin({
...
const plugin_9RNjyLX3El = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const {
    cookieOptions,
    debug,
    storage
...
const plugins = [
  ...
  plugin$1,
  plugin,
  revive_payload_server_1mUFz4J7dI,
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "header-wrapper" }, _attrs))} data-v-221f5508><div class="header-container" data-v-221f5508><h1 class="title-in-header" data-v-221f5508>Repository of Kehthe</h1><nav data-v-221f5508>`);
      _push(ssrRenderComponent(_component_RouterLink, { to: "/home" }, {
      ...
      _push(ssrRenderComponent(_component_RouterLink, { to: "/tag-list" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`タグ一覧`);
          } else {
            return [
              createTextVNode("タグ一覧")
            ];
          }
        }),
        _: 1
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-221f5508"]]);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.1_@unocss+reset@0.58.9_floating-vue@5.2.2_sass@1.72.0_unocss@0.58.9_vite@5.2.7/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.1_@unocss+reset@0.58.9_floating-vue@5.2.2_sass@1.72.0_unocss@0.58.9_vite@5.2.7/node_modules/nuxt/dist/app/components/nuxt-root.vue");
